    ...
    <div className="bg-black text-white min-h-screen pt-20">
      ...
      <section className="py-24 bg-[#0a0a0a]">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            {/* The Old Way */}
            <div>
              <h2 className="font-serif text-3xl font-bold mb-8 text-gray-400">The Amateur Approach</h2>
              <div className="space-y-4">
                {challenges.map((item, i) => (
                  <motion.div 
                    ...
                    className="p-6 rounded-xl border border-red-900/30 bg-red-900/5 flex items-start"
                  >
                    <XCircle className="w-6 h-6 text-red-500 mr-4 shrink-0 mt-1" />
                    <div>
                      <h4 className="font-bold text-gray-300 mb-1">{item.title}</h4>
              ...
              <div className="space-y-4">
                {solutions.map((item, i) => (
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.1 }}
                    className="glass-card p-6 rounded-xl gradient-border flex items-start"
                  >
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="font-serif text-4xl font-bold mb-16 text-center">The Relaunch Process</h2>
          ...
          <div className="space-y-12">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-full glass-card flex items-center justify-center font-serif text-2xl font-bold gradient-text shrink-0 mr-6">
                  0{i+1}
                </div>
                <div className="pt-2">
                  <h3 className="text-2xl font-bold mb-2 text-white">{step.phase}</h3>
      ...
      <section className="py-24 bg-[#0a0a0a] text-center border-t border-white/10">
        <div className="container mx-auto px-6">
          <h2 className="font-serif text-4xl font-bold mb-6">Your Audience is Waiting.</h2>
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">Don't let poor branding hold back phenomenal talent. Relaunch with IICA today.</p>
